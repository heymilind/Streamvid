...
export const metadata: Metadata = {
  ...
  verification: {
    other: {
      "6a97888e-site-verification": "5cc611ab4d82069afab3083e0f55edde",
    },
  },
    generator: 'v0.dev'
}
...
popMagic.init(adConfig);
        ...
        {/* Full Page Ad Provider Script */}
        <script async type="application/javascript" src="https://a.pemsrv.com/ad-provider.js" />

        {/* Full Page Ad Container */}
        <ins className="eas6a97888e35" data-zoneid="5647702" />

        {/* Full Page Ad Initialization */}
        <script
          dangerouslySetInnerHTML={{
